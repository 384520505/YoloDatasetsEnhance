...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='datasets/tea/images/val')
    parser.add_argument('--source_xml_path', type=str, default='datasets/tea/labels/val_xml')
    parser.add_argument('--save_img_path', type=str, default='datasets/tea/images/val_enhance_2')
    parser.add_argument('--save_xml_path', type=str, default='datasets/tea/labels/val_xml_enhance_2')
